...
public class ImageUtils {  
     ...
     * @return 
     */  
	private  BufferedImage fileInputImage(File file) {  
     ...
     *            :百分比 
     */  
    public  void resizeFile(String  inImgPath, String outImgPath,  
            int maxLength, float per) {
    	maxLengthResize(inImgPath, outImgPath, maxLength, per);  
    }  
     ...
     *            :百分比 
     */  
    public  void resize(String srcImgPath, String outImgPath,  
            float ratio) {  
     ...
     * @author cevencheng
     */  
    public  void flieResize(File file, String outImgPath,  
            float ratio, float per) {  
    	try{
        // 得到图片  
        BufferedImage src = fileInputImage(file);  
        int old_w = src.getWidth();  
        // 得到源图宽  
        int old_h = src.getHeight();  
        // 得到源图长  
     ...
     * @author cevencheng
     */  
    public static  void maxLengthResize(String path, String outImgPath,  
            int maxLength, float per) {  
        // 得到图片  
    ...
    public static  BufferedImage maxLengthResize2(BufferedImage src,  
    		int maxLength, float per) {  
    	// 得到图片  
    	//BufferedImage src = InputImage(path);  
    	int old_w = src.getWidth();  
     ...
     * @param per
     */
    public  void resizeFixedWidth(String srcImgPath, String outImgPath,  
    		int width, float per) {  
    	// 得到图片  
    	BufferedImage src = InputImage(srcImgPath);  
    	int old_w = src.getWidth();  
...
//            fos.close();  
     ...
     * @author cevencheng
     */
	public  void cut(File srcfile, File outfile, int x, int y, int width, int height) throws IOException {

...
import com.wy.code.tools.model.Db;
import com.wy.code.tools.model.Module;
import com.wy.code.tools.model.PackageSetting;
import com.wy.code.tools.model.TableConf;
import com.wy.code.tools.utils.XmlUtil;
...
public class Config {
	...
	public static Config loadConfig(){
		...
		//读取XML数据，根据配置的table获取表数据信息
		//Document doc = XmlUtil.getDocument(Config.class.getClassLoader().getResourceAsStream("config-system.xml"));
		Document doc = XmlUtil.getDocument(Config.class.getClassLoader().getResourceAsStream("config-mcxx.xml"));

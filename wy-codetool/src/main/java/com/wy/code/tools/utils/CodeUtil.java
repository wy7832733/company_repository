package com.wy.code.tools.utils;
...
public class CodeUtil {
     ...
     * 以s_为切割点转大写（新增方法） 
     */  
    public static String convertToTableName(String str) {  
        String result = "";  
        if (str==null) {
        	return "";
        }
        String strArr = str.trim().substring(2, str.length());  
        
        String[] strArr1 = strArr.trim().split("_");  
        ...
        //result =  strArr.substring(0, 1).toUpperCase() + strArr.substring(1).toLowerCase();  
     ...
     * 以s_为切割点转小写（新增方法） 
     */  
    public static String convertToTableNameSmall(String str) {  
    	 String result = "";  
         if (str==null) {
         	return "";
         }
